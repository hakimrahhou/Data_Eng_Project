...
def get_nantes_realtime_bicycle_data():
    """
    Récupère les données temps réel Naolib (Nantes Métropole)
    et les enregistre dans data/raw_data/YYYY-MM-DD/nantes_realtime_bicycle_data.json
    """
    base_url = (
        "https://data.nantesmetropole.fr"
        "/api/explore/v2.1/catalog/datasets/"
        "244400404_stations-velos-libre-service-nantes-metropole-disponibilites/records"
    )

    # On reste simple : on demande 100 lignes max, via params
    params = {
        "limit": 100
    }
